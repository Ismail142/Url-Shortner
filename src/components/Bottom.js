...
function Bottom() {
	return (
		<>
			...
			>
				<h2 className="text-center text-[2rem] mb-8">Boost your links today</h2>
				<a href="#" className="btn-primary px-[30px] py-[10px] text-xl">
					{" "}
					Get Started
				</a>
			</section>
			<footer className="bg-[#232027] py-10">
				<div className="container flex justify-between flex-col md:flex-row max-md:text-center
				 gap-y-[2rem]">
					<div className="md:w-72 max-md:self-center">
					...
					<div className="flex flex-col gap-y-3">
						<h5 className="text-white font-bold mb-3">Features</h5>
						<a href="#" className="text-[#9e9aa7]">
							Link Shortening
						</a>
						<a href="#" className="text-[#9e9aa7]">
							Branded Links
					...
					<div className="flex flex-col gap-y-3">
						<h5 className="text-white font-bold mb-3">Resources</h5>
						<a href="#" className="text-[#9e9aa7]">
							Blog
						</a>
						<a href="#" className="text-[#9e9aa7]">
					...
					<div className="flex gap-x-6 max-md:self-center">
						<svg
